  ...
  db.collection("hikes").get()   
      .then(allHikes => {
          allHikes.forEach(doc => {
              ...
              var hikeID = doc.data().code; //gets the unique ID field  (doublecheck that this matches the key name
              ...
              testHikeCard.querySelector('.read-more').href = "each_hike.html?hikeName="+hikeName +"&id=" + hikeID;
